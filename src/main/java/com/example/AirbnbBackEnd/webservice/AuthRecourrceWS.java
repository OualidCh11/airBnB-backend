package com.example.AirbnbBackEnd.webservice;
...
public class AuthRecourrceWS {

    private final UserService userService;
    private final ClientRegistration clientRegistration;

    public AuthRecourrceWS(UserService userService, ClientRegistrationRepository clientRegistration) {
